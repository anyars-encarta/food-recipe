...
<div align="center">
 ...
 <!-- LOGO -->
  ...
  <img src="./src/assets/food-recipe.JPG" alt="logo" width="160"  height="auto" />
  <br/>
...
> Food Recipe is an interactive app that fetches food recipes from an API based on a searched recipe. The user could view details of a recipe and they could also add and/or remove recipes from Favorites.
...
```sh
cd food-recipe
https://github.com/anyars-encarta/food-recipe.git
```
